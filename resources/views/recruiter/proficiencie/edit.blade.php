...
@section('content')
    ...
    <div class="dashboard-content-inner" >
        ...
        <div class="dashboard-headline">
            <h3><i class="icon-feather-anchor"></i> Editar proeficiencias</h3>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="dashboard-box margin-top-0">
                    ...
                    <form action="{{ route('proficiencie.update', $proficiencies->id) }}" data-redirect="true" method="post" class="form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="submit-field">
                                        <h5>Nome</h5>
                                        <input type="text" name="level"  value="{{ $proficiencies->level }}" class="with-border" placeholder="Nível">
                                    </div>
